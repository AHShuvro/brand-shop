            ...
            <div className=" p-2 lg:h-[70vh] flex justify-center items-center">
                <div className="w-full max-w-2xl mx-auto mt-10">
                    <form className="bg-[#242424] shadow-md rounded px-8 pt-6 pb-8 mb-4">
                        <h1 className="text-4xl text-white font-bold text-center pb-4">Registar</h1>
                        <div className="mb-4">
                        ...
                        <button className="btn text-xl btn-primary">Registar</button>

                        </div>
                        <p className="text-red-500 text-xl font-bold mt-1"></p>
                        <p className="pt-6 text-white text-2xl font-medium">{`Already have an account?`} <span className="text-blue-700 font-bold"><Link to="/login">login</Link></span></p>
                    </form>
                </div>
            </div>
        </div>
